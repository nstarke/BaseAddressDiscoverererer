...
def main():
    ...
    for i in range(65535):
        ...
        cmd = '/opt/ghidra-11.0.3/support/analyzeHeadless /tmp ' + n + ' -import ' + args.filename + ' -postScript CountReferencedStrings.java -processor "ARM:LE:32:Cortex" -loader BinaryLoader -loader-baseAddr ' + hex(i) + '0000 | grep CountReferencedStrings.java'
