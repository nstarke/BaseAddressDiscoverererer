...
def main():
    ...
    parser.add_argument('-s', '--start', type=lambda x: int(x.replace("0x", ""), 16), default=0, const=0, nargs='?')
    parser.add_argument('-e', '--end', type=lambda x: int(x.replace("0x", ""), 16), default=0xffffffff, const=0xffffffff, nargs='?')
    parser.add_argument('-i', '--interval', type=lambda x: int(x.replace("0x", ""), 16), default=0x10000, const=0x10000, nargs='?')
    parser.add_argument('-o', '--offset', type=lambda x: int(x.replace("0x", ""), 16), default=0, const=0, nargs='?')
